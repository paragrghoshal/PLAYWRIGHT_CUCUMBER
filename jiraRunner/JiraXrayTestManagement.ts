...
const paramData = {
    executionReportType: "junit",
    reportFileName: "./test-results/reports/junit/cucumber-report.xml",
    jiraProjectId: "10006",
    testExecutionIssueTypeId: "10014",
    issueSummary: "This script created via automation script",
    issueDesc: "issue desc",
    executionReportFolderPath: "./test-results/reports/multi_reports"
}
